...
<label><?php echo xlt('Consultation Brief'); ?>:</label>
 ...
 <div class="form-group">
  <label><?php echo $GLOBALS['athletic_team'] ? xlt('Text Diagnosis') : xlt('Diagnosis'); ?>:</label>
   ...
   <input type='text' size='40' name='form_title' class='form-control' value='<?php echo attr($irow['title']) ?>' style='width:100%' />
...
<input type='text' name='form_diagnosis' class='form-control' id="search-input" value='<?php echo attr($irow['diagnosis']) ?>'
    title='<?php echo xla('Click to select or change coding'); ?>' placeholder="Search ICD9 name" />
 ...
 <div class="form-group">
     <label><?php echo xlt('Next Appointment:'); ?></label>
                ...
                <div class='input-group date'  id='datetimepicker1' >
                    <input type='text' name='next_date' class="form-control"  <?php echo $disabled ?> title='<?php echo xla('yyyy-mm-dd Next Appointment'); ?>'  onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc)' />
    ...
    <div style="visibility:hidden">
     <td class='bold' nowrap><?php echo xlt('Center:'); ?></td>
     <td class='text'>
...
?>
	...
	<div  style="visibility: hidden">
		<td class='bold' nowrap><?php echo xlt('Billing Center'); ?>:</td>
		<td class='text'>
			<div id="ajaxdiv">
			<?php
...
<div class="form-group" style="visibility: hidden">
     <label><?php echo xlt('Date of Service:'); ?></label>
