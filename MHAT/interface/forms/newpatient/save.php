...
$ndate             = (isset($_POST['next_date']))            ? $_POST['next_date'] : '';
...
if ($mode == 'new')
{
    ...
    sqlInsert("INSERT INTO form_encounter SET " .
      "date = '" . add_escape_custom($date) . "', " .
	   "next_date = '" . add_escape_custom($ndate) . "', " .
    ...
    sqlInsert("INSERT INTO billing SET " .
	 ...
	 $issue = sqlInsert("INSERT INTO lists (date,next_date, pid, title, begdate, enddate, diagnosis, user, groupname, encounter) VALUES (NOW(), '". $ndate ."','". $pid ."' , '" . add_escape_custom($_POST['form_title'])       . "','". QuotedOrNull($form_begin) ."', '". QuotedOrNull($form_end) ."', '". add_escape_custom($_POST['form_diagnosis'])   . "', '" . $_SESSION['authUser']     . "', '" . $_SESSION['authProvider'] . "', '" . add_escape_custom($encounter) . "')");
