...
if($_POST['form_save'])
{
	sqlInsert("INSERT into opd_card SET
	pid={$_SESSION["pid"]},
	encounter={$_SESSION["encounter"]},
    user = '" . $_SESSION["authUser"] . "',
   date = NOW(),
  presenting_complaints       = '" . add_escape_custom($_POST["presenting_complaints"]) . "',
  oe          = '" . add_escape_custom($_POST["oe"]) . "',
  investigations          = '" . add_escape_custom($_POST["investigations"]) . "',
 provisional_diagnosis          = '" . add_escape_custom($_POST["provisional_diagnosis"]) . "',
  treatment_advised         = '" . add_escape_custom($_POST["treatment_advised"]) . "',
  reffered_to         = '" . add_escape_custom($_POST["reffered_to"]) . "'");
...
<body ><hr>
<form name='theform' method='post' action='opprint.php' id='theform'>
<table  border="0">
