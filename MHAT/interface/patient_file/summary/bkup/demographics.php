...
$qry = "SELECT lists.date,lists.next_date, lists.title, form_encounter.provider_id,form_encounter.reason,form_encounter.encounter,form_encounter.sensitivity
...
$content .='<ul class="timeline" id="pageData"></ul>';
if($count > 0){
                        ...
                        <!-- timeline time label -->
                            ...
                            <li>
                                    ...
                                    <div class="user-block" style="display: inline-block;">
									  ...
									  <a href="<?php echo $GLOBALS['webroot'] ?>/controller.php?prescription&edit&id=&pid=<?php echo $pid ?>" class="element iframe rx_modal pull-right" onclick='setEnc(<?php echo $prow['encounter'] ?>)' data-toggle="tooltip" data-placement="top" title="Add Prescription">
...
$(document).ready(function(){
   $(".element").tooltip();
									  ...
									  <?php if($prow['sensitivity'] != null) { ?>
  <tr>
  <th>Status</th>
    <td><?php echo $prow['sensitivity']; ?></td>
	</tr>
	<?php } ?>
	<?php if($prow['reason'] != null) { ?>
	<tr>
									  
    <th>Reason</th>
	<td><?php echo $prow['reason']; ?></td>
		</tr>
		<?php } ?>
		<?php if($prow['title'] != null) { ?>
	<tr>
	<th>Diagnosis</th>
...
AND encounter = ?";
  ...
  <th>Prescription</th>
    <td><?php echo $pres['drug']; ?> : <?php echo $pres['title']; ?></td>

	 	</tr>
			 <?php } ?>
	<tr>
    <th>Next Appointment</th>
	<td><?php echo $prow['next_date']; ?></td>
		</tr>
...
<div ng-controller="PaginationDemoCtrl">
    ...
    <ul uib-pagination total-items="bigTotalItems" ng-model="bigCurrentPage" max-size="maxSize" class="pagination-sm" previous-text="&lsaquo;" total-items="totalItems" next-text="&rsaquo;" first-text="&laquo;" last-text="&raquo;" boundary-link-numbers="true" rotate="false" num-pages="numPages"></ul>
