...
<li><a href="../report/patient_report.php" id="demographics" class="black-tooltip print iframe " data-original-title="Tooltip on bottom" onclick='top.restoreSession()'  data-toggle="tooltip" data-placement="bottom" title="Print Demographics Details"></a></li>
</ul>
...
<div class="container">
<div class="row">
<div class="col-md-8" ng-app="ui.bootstrap.demo">
...
$( document ).ready(function() {
$('#demographics_ps_expand').css('display','none');
