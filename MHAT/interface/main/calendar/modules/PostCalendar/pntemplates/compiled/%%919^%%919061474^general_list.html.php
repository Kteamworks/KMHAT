<?php /* Smarty version 2.6.2, created on 2018-07-10 12:37:41
         compiled from C:/xampp/htdocs/KMHAT/MHAT/templates/prescription/general_list.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'xl', 'C:/xampp/htdocs/KMHAT/MHAT/templates/prescription/general_list.html', 92, false),)), $this); ?>
<html>
<head>
...
" onclick="top.restoreSession()" ><span></span></a>
                        </td>
...
<table width="100%" class="showborder_head" cellspacing="0px" cellpadding="2px">
    <tr> 
       <!-- TajEmo Changes 2012/06/14 02:01:43 PM by CB added Heading for checkbox column -->   
        <th width="8px">&nbsp;</th>
        <th width="150px"><?php echo smarty_function_xl(array('t' => 'Medicine Name'), $this);?>
</th>
        <th><?php echo smarty_function_xl(array('t' => 'Created'), $this);?>
<br /><?php echo smarty_function_xl(array('t' => 'Changed'), $this);?>
</th>
        <th><?php echo smarty_function_xl(array('t' => 'Time'), $this);?>
</th>
         <th><?php echo smarty_function_xl(array('t' => 'Meal'), $this);?>
.</th>
       <th><?php echo smarty_function_xl(array('t' => 'Duration'), $this);?>
</th>
		   <th><?php echo smarty_function_xl(array('t' => 'Created By'), $this);?>
</th>
    </tr>
...
" style="margin-top:-2px"><span><?php echo smarty_function_xl(array('t' => 'Edit'), $this);?>
	...
	<td class="editscript"  id="<?php echo $this->_tpl_vars['prescription']->id; ?>
">
	<?php if ($this->_tpl_vars['prescription']->active > 0): ?><b><?php endif;  echo $this->_tpl_vars['prescription']->drug; ?>
(<?php echo $this->_tpl_vars['prescription']->dosage;  echo $this->_tpl_vars['prescription']->get_unit_display(); ?>
...
&nbsp;
      ...
      <td id="<?php echo $this->_tpl_vars['prescription']->id; ?>
">
      <?php echo $this->_tpl_vars['prescription']->get_drug_intervals(); ?>
 &nbsp;
    </td>

    <td class="editscript" id="<?php echo $this->_tpl_vars['prescription']->id; ?>
">
      <?php echo $this->_tpl_vars['prescription']->get_drug_meal_time(); ?>
 &nbsp;
    </td>

	<td id="<?php echo $this->_tpl_vars['prescription']->id; ?>
">
      <?php echo $this->_tpl_vars['prescription']->get_duration(); ?>
 
	  <?php if ($this->_tpl_vars['prescription']->get_time_frame() == 1): ?>
	  <?php echo smarty_function_xl(array('t' => 'Days'), $this);?>
&nbsp;
	  <?php endif; ?>
	  <?php if ($this->_tpl_vars['prescription']->get_time_frame() == 2): ?>
	  <?php echo smarty_function_xl(array('t' => 'Weeks'), $this);?>
&nbsp;
	  <?php endif; ?>
	  <?php if ($this->_tpl_vars['prescription']->get_time_frame() == 3): ?>
	  <?php echo smarty_function_xl(array('t' => 'Months'), $this);?>
&nbsp;
	  <?php endif; ?>
	   <?php if ($this->_tpl_vars['prescription']->get_time_frame() == 4): ?>
	  <?php echo smarty_function_xl(array('t' => 'Years'), $this);?>
&nbsp;
	  <?php endif; ?>
    </td>
    <td id="<?php echo $this->_tpl_vars['prescription']->id; ?>
