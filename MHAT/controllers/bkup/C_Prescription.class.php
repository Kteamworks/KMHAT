    ...
    if ($GLOBALS['rx_enable_SLN']) {
        ...
        function multiprintcss_header($p) {
		 ...
		 echo("</td>\n");
            ...
            $res = sqlQuery("SELECT  concat('\n','<br>','&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',street,'<B>','\n ','&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;','</B>',city,', ',state,' ',postal_code,'\n','<B>','&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;','</B>',if(phone_home!='',phone_home,if(phone_cell!='',phone_cell,if(phone_biz!='',phone_biz,'')))) addr,sex from patient_data where pid =". mysql_real_escape_string ($p->patient->id));    
			$patterns = array ('/\n/');
	        $replace = array ('<br>');
	        $res = preg_replace($patterns, $replace, $res);
